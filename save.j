  ...
  function showMiniWindowModal() {
    ...
    alertModal.innerHTML = `
      <div class="tm-mini-window" role="dialog" aria-label="Thông báo cảnh báo">
        ...
        <a href="https://docs.google.com/spreadsheets/d/1VusUQdljH-jqMFIQK4g_sQFvAqmVFBB9hra_DFUDgok/edit?pli=1&gid=773053306#gid=773053306" target="_blank" style="text-decoration: none;"> Danh sách NV</a>
